...
| -------- | -------- | ------ | -------- |
| [Глава 1](./глава-один/введение.md) | Изучение основ technical writing. Возьмите этот курс перед тем как приступать к другим. | 2 часа | от 2 до 2.5 часов |
| [Глава 2](./глава-два/введение.md) | Практика в четырех продвинутых темах по technical writing. | 1 час | от 2 до 2.5 часов |
| [Доступность](./доступность/введение.md) | Развитие навыка, позволяющего сделать документацию более доступной для всех. | - | 1.5 часа |
| [Обработка ошибок](./обработка-ошибок/введение.md) | Научит писать более четкие и эффективные сообщения об ошибках, независимо от того, для IDE они, командной строки или графического интерфейса. Этот курс доступен только онлайн. | 1.5 часа | - |
...
**Продолжить чтение:** [Technical writing Глава 1 Введение](./глава-один/введение.md)
